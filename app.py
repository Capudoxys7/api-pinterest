...
def get_video_link():
    ...
    return jsonify({"video_url": f"{request.url_root}api/download_video_file?video_url={convert_url}"})
...
def get_image_link():
    ...
    return jsonify({"image_url": f"{request.url_root}api/download_image_file?img_url={img_url}"})
